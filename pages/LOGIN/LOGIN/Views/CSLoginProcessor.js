...
function getLoginResult() {
    ...
    var reqApiUrl = "/ECAPI/Common/Login/GetCSLoginResult";
        ...
        success: function (returnData) {
            ...
            if (returnData.Status == "200") {
                if (returnData.Data.Code == "00") { // 로그인 정상, 이후 프로세스 진행                    
                    ...
                    loginSuccess(returnData.Data.Datas.HOST_URL);
                }
                else {
...
function loginSuccess(url, param) {
    ...
    _form.action = _https + "://" + url + "/ECERP/LOGIN/CSLoginSuccess?ec_req_sid=" + _ec_req_sid;
    _form.submit();
}
