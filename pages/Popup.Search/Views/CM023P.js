window.__define_resource && __define_resource("LBL05647","BTN00113","BTN00351","BTN00007","LBL05648","LBL00703","BTN00004","BTN00603","BTN00069","BTN00008","LBL01118","LBL01099","MSG03839","MSG00962");
/****************************************************************************************************
1. Create Date : 2015.11.10
2. Creator     : NGUYEN TRAN QUOC BAO
3. Description : Get data for widget Tax Type [ Lấy dữ liệu cho  widget Tax Type ]
4. Precaution  : 
5. History     : 2019.05.29 [DucThai] A18_04115 - 임시삭제 용어 정리하기
****************************************************************************************************/
ecount.page.factory("ecount.page.popup.type2", "CM023P", {
    newItem: false,
    /**********************************************************************
    *  page init
    **********************************************************************/
    ...
    **********************************************************************/
    ...
    onInitHeader: function (header, resource) {
        ...
        header.setTitle(ecount.resource.LBL05647).useQuickSearch();
        ...
        //if (this.isIncludeInactive == false) {
    ...
    onInitContents: function (contents, resource) {
        ...
        settings
            ...
            .setRowDataUrl('/Account/Basic/GetListCom011ForTaxType')
            .setRowDataParameter(this.searchFormParameter)
            .setKeyColumn(['VAT_CODE', 'VAT_DES'])
            .setColumns([
                { propertyName: 'IO_TYPE', id: 'IO_TYPE', title: ecount.resource.LBL00703, width: '70', align: 'center', isHideColumn: this.FROM_MENU == "EIL" },
                { propertyName: 'VAT_CODE', id: 'VAT_CODE', title: ecount.resource.LBL05647, width: '110' },
                { propertyName: 'VAT_DES', id: 'VAT_DES', title: ecount.resource.LBL05648, width: '' }
            ])
            ...
            .setCustomRowCell('VAT_CODE', this.setGridDateLink.bind(this))
            .setCustomRowCell('VAT_DES', this.setGridDateLink.bind(this))
            .setCustomRowCell('IO_TYPE', this.setGridIO_TYPE.bind(this))
    ...
    **********************************************************************/
    ...
    setGridIO_TYPE: function (value, rowItem) {
        var option = {};
        option.data = value == '1' ? ecount.resource.LBL01118 : ecount.resource.LBL01099;
    ...
    onGridRenderComplete: function (e, data, gridObj) {
        //var cnt = (this.isOthersDataFlag != "N" || !this.isOnePopupClose) ? 2 : 1;

        if (data.dataCount === 1 && this.contents.getGrid().settings.getPagingCurrentPage() === 1 && (this.isOnePopupClose) && this.isDataLinkFlag == false) {
            var obj = {};
    ...
    setColumnSortClick: function (e, data) {
        ...
        if (this.isDataLinkFlag)
            this.searchFormParameter.VAT_CLASS_CD = this.VAT_CLASS_CD
